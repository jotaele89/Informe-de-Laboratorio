...
\begin{center}
\includegraphics[scale=1{./images/6-2 Ejercicio/1.png}\\
\end{center}

Primero ingresamos a las opciones SQL\\
\begin{center}
\includegraphics[scale=1{./images/6-2 Ejercicio/2.png}\\
\end{center}

Ahora simplemente entramos a las opciones de SQL comandos para poder agregar cualquier tipo de comando SQL\\
\begin{center}
\includegraphics[scale=1{./images/6-2 Ejercicio/3.png}\\
\end{center}

Aqui podremos agregar comandos y crea tablas y bases de datose\\
\begin{center}
\includegraphics[scale=1{./images/6-2 Ejercicio/4.png}\\
\end{center}

Para el uso de Scripts seleccionamos esta opcion y podremos VER los scripts disponibles asi como crear y subir mas scripts\\
\begin{center}
\includegraphics[scale=1{./images/6-2 Ejercicio/5.png}\\
\includegraphics[scale=1{./images/6-2 Ejercicio/6.png}\\
\end{center}
